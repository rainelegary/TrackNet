...
class MessageConverter:
    ...
    @staticmethod
    def railway_obj_and_ts_to_railway_update_msg(
        railway: Railway, timestamp: str
    ) -> TrackNet_pb2.RailwayUpdate:
    ...
    @staticmethod
    def railway_update_msg_to_railway_obj_and_ts(
        msg: TrackNet_pb2.RailwayUpdate,
    ) -> "tuple[Railway, str]":
    ...
    @staticmethod
    def railway_obj_to_msg(
        railway: Railway, RailWayMsg: TrackNet_pb2.RailwayUpdate
    ) -> TrackNet_pb2.Railway:
        ...
        for train_name, train in railway.trains.items():
            MessageConverter.train_obj_to_msg(
                train, RailWayMsg.railway.trains[train_name]
            )
    ...
    @staticmethod
    def railmap_obj_to_msg(
        railmap: Railmap, RailWayMsg_railway_map: TrackNet_pb2.Railmap
    ) -> TrackNet_pb2.Railmap:
        ...
        for junction_name, junction in railmap.junctions.items():
            ...
            MessageConverter.junction_obj_to_msg(
                junction, RailWayMsg_railway_map.junctions[junction_name]
            )
        ...
        for track_name, track in railmap.tracks.items():
            MessageConverter.track_obj_to_msg(
                track, RailWayMsg_railway_map.tracks[track_name]
            )
        return msg
    ...
    def railmap_obj_to_msg2(railmap: Railmap) -> TrackNet_pb2.Railmap:
        msg = TrackNet_pb2.Railmap()
        for junction_name, junction in railmap.junctions.items():
            msg.junctions[junction_name].CopyFrom(
                MessageConverter.junction_obj_to_msg(junction)
            )
        for track_name, track in railmap.tracks.items():
    ...
    @staticmethod
    def junction_obj_to_msg(
        junction: Junction, junctionProto: TrackNet_pb2.Junction
    ) -> TrackNet_pb2.Junction:
    ...
    @staticmethod
    def junction_msg_to_obj(
        msg: TrackNet_pb2.Junction, track_refs: "dict[str, Track]"
    ) -> Junction:
        pass
    ...
    def track_msg_to_obj(msg: TrackNet_pb2.Track) -> Track:
        ...
        track_obj = Track(
            msg.junction_a, msg.junction_b, msg.length, None, condition, speed
        )
        return track_obj

    @staticmethod
    def track_condition_py_to_proto(
    ...
    @staticmethod
    def track_condition_proto_to_py(
    ...
    @staticmethod
    def train_obj_to_msg(
        train: Train, trainProto: TrackNet_pb2.Train
    ) -> TrackNet_pb2.Train:
    ...
    @staticmethod
    def location_obj_to_msg(
        location: Location, locationProto: TrackNet_pb2.Location
    ) -> TrackNet_pb2.Location:
    ...
    def location_msg_to_obj(
        ...
        location = Location()
        location.front_cart = {
            "track": track_refs[msg.front_track_id],
            "junction": junction_refs[msg.front_junction_id],
            "position": msg.front_position
        }
        location.back_cart = {
            "track": track_refs[msg.back_track_id],
            "junction": junction_refs[msg.back_junction_id],
            "position": msg.back_position
        }
    ...
    def route_obj_to_msg(
        route: Route, RouteProto: TrackNet_pb2.Route
    ) -> TrackNet_pb2.Route:
    ...
    def route_msg_to_obj(
        ...
        route.destination = junction_refs[msg.destination]
